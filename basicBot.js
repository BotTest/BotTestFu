...
(function () {
    ...
    var loadChat = function (cb) {
        ...
        $.get("https://rawgit.com/BotTest/BotTestFu/master/lang/langIndex.json", function (json) {
    ...
    var basicBot = {
        ...
        name: "basicBot",
        loggedInID: null,
        scriptLink: "https://rawgit.com/BotTest/BotTestFu/master/basicBot.js",
        cmdLink: "http://git.io/245Ppg",
        chatLink: "https://rawgit.com/BotTest/BotTestFu/master/lang/pt-BR.json",
        chat: null,
        loadChat: loadChat,
        ...
        settings: {
            ...
            commandLiteral: "!",
            blacklists: {
                NSFW: "https://rawgit.com/BotTest/basicBot-customization/master/blacklists/NSFWlist.json",
                OP: "https://rawgit.com/BotTest/basicBot-customization/master/blacklists/OPlist.json",
                BANNED: "https://rawgit.com/BotTest/basicBot-customization/master/blacklists/BANNEDlist.json"
            }
        },
        room: {
            name: null,
        ...
        startup: function () {
            ...
            API.chatLog(':1234: Capacidade de avatares ' + basicBot.settings.startupCap);
            API.chatLog(':signal_strength: Volume ajustado para ' + basicBot.settings.startupVolume);
            socket();
            ...
            languageCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        $.get("https://rawgit.com/BotTest/basicBot/master/lang/langIndex.json", function (json) {
                            var langIndex = json;
