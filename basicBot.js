...
(function () {
    ...
    var loadChat = function (cb) {
        ...
        $.get("https://rawgit.com/BotFarofa/Farofa-Bot/master/lang/langIndex.json", function (json) {
    ...
    var basicBot = {
        ...
        name: "basicBot",
        loggedInID: null,
        scriptLink: "https://rawgit.com/BotFarofa/Farofa-Bot/master/basicBot.js",
        ...
        settings: {
            ...
            "Isso já esta decidido mana, NÃO!",
            ...
            "Minhas fontes dizem que não pra esse inferno.",
            "Definitivamente não.",
        ...
        commands: {
            ...
            clearchatCommand: {
                command: ['bostejarchat', 'apagar', 'clearchat']
                rank: 'bouncer',
                type: 'exact',
                functionality: function (chat, cmd) {
                    if (this.type === 'exact' && chat.message.length !== cmd.length) return void (0);
